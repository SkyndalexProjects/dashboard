...
export default function Page() {
    const [starboardChannelSearchTerm, setStarboardChannelSearchTerm] = useState("");
    const [starboardTypeSearchTerm, setStarboardTypeSearchTerm] = useState("");
    const [welcomeChannelSearchTerm, setWelcomeChannelSearchTerm] = useState("");
    const [goodbyeChannelSearchTerm, setGoodbyeChannelSearchTerm] = useState("");
        ...
        <div>
            ...
            <div className={classes.settingsContainer}>
                <p className={classes.containerSubtitle}>
                    ...
                    >
                        {filteredChannels(starboardChannelSearchTerm).map((channel) => (
            ...
            <div className={classes.settingsContainer}>
                <p className={classes.containerSubtitle}>
                    ...
                    <SearchSelect
                        ...
                        indicatorClassName={classes.searchIndicator}
                    >
                        {filteredChannels(welcomeChannelSearchTerm).map((channel) => (
                            <SelectOption key={channel.id} value={channel.name}>
                                {channel.name}
                            </SelectOption>
                        ))}
                    ...
                    <SearchSelect
                        ...
                        indicatorClassName={classes.searchIndicator}
                    >
                        {filteredChannels(goodbyeChannelSearchTerm).map((channel) => (
                            <SelectOption key={channel.id} value={channel.name}>
                                {channel.name}
                            </SelectOption>
                        ))}
