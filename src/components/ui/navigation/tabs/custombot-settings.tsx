...
const CustombotSettingsTabs = () => {
    ...
    const [modelList, setModelList] = useState<{ models: { id: string; name: string }[] }>({ models: [] });
                    ...
                    <div>
                        <div className={classes.chatbotTabContent}>
                            ...
                            <div className={classes.chatbotSettingBox}>
                                ...
                                <div className={classes.chatbotSettingBoxContent}>
                                    <Select
                                        value={searchTerm}
                            ...
                            <div className={classes.chatbotSettingBox}>
                                ...
                                <div className={classes.chatbotSettingBoxContent}>
                                    ...
                                    >
                                        {modelList.models.map((model: { id: string; name: string }) => (
                                            <SelectOption
                                                key={model.id}
                                                value={model.id}
                                            >
